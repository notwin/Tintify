...
Tintify 是一个 macOS 菜单栏应用，可以同时切换 **13 个终端工具**的配色主题。内置 **28 个精选主题**，覆盖从经典到前沿的热门配色方案，另有 9 个 Tintify 原创主题。
...
| [kitty](https://sw.kovidgoyal.net/kitty/) | 生成配色写入 kitty.conf | ✅ SIGUSR1 重载 |
